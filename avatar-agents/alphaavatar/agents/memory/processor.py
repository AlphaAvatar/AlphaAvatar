...
class MemoryProcessorBase(ABC):
    capabilities: tuple[AvatarCapability, ...] = ()

    def __init__(self, *, runtime: AvatarRuntime, memory: MemoryBase) -> None:
        ...
        async with self._lifecycle_lock:
            ...
            try:
                ...
                try:
                    ...
                    logger.exception("Failed to rollback Memory processor name=%s", self.name)
                raise
